        ...
        if "Drowsiness" in class_names:
            ...
            if results_mesh.multi_face_landmarks:
                ...
                if mar_counter >= MAR_FRAMES:
                    ...
                    elif current_time - yawn_start_time >= 1.0 and not alarm_played:  # หาว >=1 วิ
                        print("😮 Yawning detected!")
                        playsound("yawn.mp3")
                        yawning_detected = True
                        alarm_played = True
                ...
                # ตรวจตาปิด (Eyes Closed)
                if ear_counter >= EAR_FRAMES:
                    if drowsy_start_time is None:
                        drowsy_start_time = current_time
                    elif current_time - drowsy_start_time >= 2.5 and not alarm_played:  # ตาปิด >=2.5วิ
                        print("😴 Eyes closed detected!")
                        playsound("alarm.mp3")
                        eyes_closed_detected = True
                        alarm_played = True
